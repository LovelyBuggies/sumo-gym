        ...
        for i in range(n_vehicle):
            if self.is_loading[i][0] != -1:  # is on the way
                ...
                samples[i] = (
                    ...
                    else ((self.is_loading[i][0], self.is_loading[i][1]), -1, loc)
                )
                ...
                samples[i] = (
                    ((self.is_loading[i][1], self.is_loading[i][1]), -1, loc)
                ...
                if (
                    ...
                    samples[i] = (
                        (-1, -1),
                        self.is_charging[i],
                        self.charging_stations[self.is_charging[i]][0],
                    )
                else:
                ...
                if np.random.random() < possibility_of_togo_charge:
                    ...
                    if len(available_dmd):
                        ...
                        samples[i] = (
                            ((dmd_idx, dmd_idx), -1, loc)
                            if loc == self.demand[dmd_idx][0]
                            else ((-1, dmd_idx), -1, loc)
                        )
                    else:
                        print("----- IDLE...")
