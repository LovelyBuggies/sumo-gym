...
class ReplayBuffer(Memory):
    ...
    def __init__(self, state_dim, action_dim, min_train_size=None, max_size=1_000, n_step_return=None, gamma=None,
                 device=None):
        super().__init__()
...
class PrioritizedExperienceReplay(Memory):
    ...
    def __init__(self, state_dim, action_dim, min_train_size=None, max_size=1_000, n_step_return=None, gamma=None,
        ...
        self.ReplayBuffer = ReplayBuffer(state_dim, action_dim, min_train_size, max_size, n_step_return=n_step_return,
