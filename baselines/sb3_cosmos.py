...
class MADQN(object):
    ...
    def train(self):
        ...
        for episode in range(self.episodes):
            ...
            reward_sum_upper_mean = {agent : reward_sum_upper[agent] / episode_step[agent] for agent in env.possible_agents}
            reward_record = {episode: reward_sum_upper_mean}
            reward_record_lower = {episode: reward_sum_lower / max(episode_step.values())}
            loss_mean_record = {
                episode: {
